  ...
  try {
    ...
    if (action === "settings-save") {
      await db.from("app_settings").upsert({
        ...
        morning_start: String(form.get("morning_start") ?? "06:30"),
        morning_end: String(form.get("morning_end") ?? "07:30"),
        afternoon_start: String(form.get("afternoon_start") ?? "16:30"),
        afternoon_end: String(form.get("afternoon_end") ?? "17:30"),
        evening_start: String(form.get("evening_start") ?? "21:30"),
        evening_end: String(form.get("evening_end") ?? "22:30"),
        min_stagger_minutes: numberField(form, "min_stagger_minutes") ?? 0,
        max_stagger_minutes: numberField(form, "max_stagger_minutes") ?? 59,
